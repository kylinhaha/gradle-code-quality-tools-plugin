...
public class CodeQualityToolsPluginTest {
    ...
    private void assertLint(Project project) {
        ...
        assert project.android.lintOptions.baseLine == null
    ...
    public void testLintConfigurations() {
        ...
        extension.lint.baseline = File.createTempFile("test", "test")
        ...
        assert androidAppProject.android.lintOptions.baseline == extension.lint.baseline
        ...
        assert androidLibraryProject.android.lintOptions.baseline == extension.lint.baseline
